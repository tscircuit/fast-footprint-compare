...
const getFootprintBounds = (shapes) => {
  if (!shapes.length) {
    return {
      height: 1,
      maxX: 0.5,
...
const translateFootprint = (footprint, deltaX, deltaY) => ({
  ...footprint,
...
const centerFootprint = (footprint) => {
